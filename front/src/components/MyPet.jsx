...
function MyPet({ pets, healthLogs, currentId, setScreen }) {
  ...
  const myLogs = healthLogs
    .filter((log) => log.petId === String(currentId))
    .map((log) => {
      let foodScore = 3;
      ...
      <div>
        ...
        {myLogs.length > 0 ? (
          <div>
            <div>
              <p>体重 (kg)</p>
              <LineChart data={myLogs} className="weight-chart">
            ...
            <div>
              ...
              <LineChart data={myLogs} className="food-chart">
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="date" />
            ...
            <div>
              ...
              <LineChart data={myLogs} className="water-chart">
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="date" />
                <YAxis domain={[1, 3]} ticks={[1, 2, 3]} />
                <Tooltip />
            ...
            <div>
              ...
              <LineChart data={myLogs} className="poop-chart">
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="date" />
                <YAxis domain={[1, 3]} ticks={[1, 2, 3]} />
                <Tooltip />
